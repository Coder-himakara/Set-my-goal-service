...
public class ReviewCycleServiceImpl implements ReviewCycleService {
    ...
    @Override
    public ReviewCycleResponse createCycle(ReviewCycleDto reviewCycleDto) {
        if (hasOngoingCycle()) {
        ...
        return reviewCycleMapper.toResponseDTO(savedReviewCycle);
    }


    @Override
    public ReviewCycleResponse updateCycle(Long id, ReviewCycleDto reviewCycleDto) {
        ...
        return reviewCycleMapper.toResponseDTO(updatedReviewCycle);
    }
